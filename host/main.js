...
const initDB = num => {
  ...
  db.push({fileCount:'12', title: 'Volume XII',articleSrc: 'articles/2021/07/pt2/the_american_reality.html',preview: text, date: "July 15, 2021"});
  ...
  db.push({fileCount:'11', title: 'Volume XI',articleSrc: 'articles/2021/07/pt1/interlude.html',preview: text, date: "July 1, 2021"});
